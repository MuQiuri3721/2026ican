...
| 项 | 冻结口径 | 禁止出现的旧口径 |
|---|---|---|
| 资源池 | 2+6+4 十二架独立 UAV（2026-09-08 扩编，旧口径 2+4+2）：R1–R2 侦察、E1–E6 灭火、S1–S4 支援（S3/S4 multi_role 可参与灭火），按需动态出动 | 固定三架、DR-01/02/03、drone-1/2/3 |
...
- 2+6+4 资源池（2026-09-08 由 2+4+2 扩编）、确定性规则链、审批闭环、5 分钟反馈重规划、报告归档、紫金山环境查询（含离线回退）、契约测试与前端构建。
