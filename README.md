...
| 资源池 | 已统一 | 2+4+2：R1–R2 侦察、E1–E4 灭火、S1–S2 支援 |
| 环境 | 已接入 | 紫金山地形、风场、水源、道路和等高线；支持离线/演示回退 |
| 审批与闭环 | 已接入 | 确认/拒绝/调整/终止、资源锁、5 分钟反馈与重规划 |
| 报告 | 已接入 | 保留输入、方案版本、审批、轮次、事件、消耗和结论 |
| 真实模型/飞控 | 待接入 | 当前为 fixture/规则仿真，不连接真实设备 |
...
- **资源**：2+4+2 八架独立 UAV，不是固定三架；系统根据火情和硬约束动态出动。R 负责监测，E 负责灭火，S 负责通信、人员指引、物资/电池运输和后备保障。
