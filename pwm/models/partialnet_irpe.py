...
Ported from PartialNet (arXiv:2502.01303) source: models/irpe.py.
Only change: replace the `easydict` dependency with a local shim
(the machine cannot pip-install packages).
"""


class EasyDict(dict):
    """Minimal easydict replacement: dict with attribute access."""
